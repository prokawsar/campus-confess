...
<div id="footer">
  <div class="container">
    <p class="text-muted credit">Website built with <a href="http://laravel.com" target="_blank">Laravel</a>
    | <a href="/about">About</a> | <a href="{{ route('terms') }}">Terms and Conditions</a>
